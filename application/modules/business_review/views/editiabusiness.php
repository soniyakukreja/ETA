							...
							<div class="innerDiv">
								...
								<div class="filterBody">
									<div class="filterDiv">
										...
										<?php echo form_open('',array('class'=>'addForm','id'=>'editiabusiness','enctype'=>'multipart/form-data','autocomplete'=>'off')); ?>
											<div class="row">
															...
															<div class="col-md-6">
																<div class="form-group">
																	...
																	<div class="input-group"><span class="input-group-addon">
																		...
																		<input  name="busrev_file" id="busrev_file" class="form-control" value="" type="file" accept=".pdf"  autocomplete="off">
																		<i class="fa fa-times-circle removeFile" aria-hidden="true"></i>
																	</div>
																	<label>Only Supported File is PDF</label>
																	<span id="busrev_file_err" class="invalidText"></span>
																</div>
															</div>
