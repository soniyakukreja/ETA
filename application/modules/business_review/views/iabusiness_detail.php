...
<div class="panel panel-default">
  <div class="panel-heading">  <h4>Business Review  <a href="<?php echo site_url() ?>business_review/editlicbusiness/<?php echo $ia['busrev_id']; ?>" style="float: right;"><span class="glyphicon glyphicon-pencil"></span> Edit</a>
...
<div class="col-sm-5 col-xs-6 tital ">Title:</div><div class="col-sm-7"><?php echo $ia['busrev_title']; ?></div>
...
<div class="col-sm-5 col-xs-6 tital ">Due Date:</div><div class="col-sm-7"> 
    ...
    $busrev_duedate = gmdate_to_mydate($ia['busrev_duedate'],$localtimzone);
            
	echo date('m-d-Y',strtotime($busrev_duedate)); 
	// echo date('m-d-Y',strtotime($ia['busrev_duedate'])); 
	?></div>
  <div class="clearfix"></div>
<div class="bot-border"></div>
...
<div class="col-sm-5 col-xs-6 tital ">Business Review File:</div><div class="col-sm-7"> <?php if($ia['busrev_file']){ ?><a href="<?php echo base_url('uploads/lic_business/').$ia['busrev_file']; ?>" class="downldBtn" target="_blank" download="">Download <span class="glyphicon glyphicon-download-alt"></span></a><?php } ?></div>
  <div class="clearfix"></div>
<div class="bot-border"></div>

<div class="col-sm-5 col-xs-6 tital ">Type:</div><div class="col-sm-7"> <?php echo $ia['busrev_type']; ?></div>
  <div class="clearfix"></div>
<div class="bot-border"></div>

<div class="col-sm-5 col-xs-6 tital ">Status:</div><div class="col-sm-7"><?php echo $ia['busrev_status']; ?></div>
<div class="clearfix"></div>
<div class="bot-border"></div>

<?php if($ia['busrev_status']=="Completed"){ ?>
	<div class="col-sm-5 col-xs-6 tital ">Date Completed:</div><div class="col-sm-7"> 
		<?php 
		$localtimzone =$this->userdata['timezone'];
    	$busrev_complete = gmdate_to_mydate($ia['busrev_complete'],$localtimzone);
...
<script type="text/javascript" charset="utf-8">
        $(document).ready(function() {
            var url = "<?php echo site_url() ?>business_review/viewnoteia";
    ...
    <!-- Modal content-->
     <div class="modal-content">
		<div class="addNote">
			...
			<h3>Add Note</h3>
		<?php echo form_open('business_review/addnoteia',array('class'=>'addForm','id'=>'add_note','enctype'=>'multipart/form-data','autocomplete'=>'off')); ?>
