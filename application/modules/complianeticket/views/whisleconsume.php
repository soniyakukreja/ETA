								...
								<div class="filterBody">
									<div class="filterDiv">
										...
										<div class="filterTable exportButton expBtn proTable">
											...
											<form action="<?php echo site_url() ?>complianeticket/whistleblower/exportconsume" method="POST">
...
<script>
	function loadTableData(){
            var url = "<?php echo site_url() ?>complianeticket/whistleblower/ajaxconsume";
            $('#example').dataTable( {
                "serverSide": true,
                "ajax" : url,
