							...
							<div class="innerDiv">
								...
								<div class="filterBody">
									<div class="filterDiv">
										...
										<?php echo form_open('',array('class'=>'addForm','id'=>'add_consumer','enctype'=>'multipart/form-data','autocomplete'=>'off')); ?>
											<div class="row">
												<div class="col-md-6">
											...
											<div class="row">
												<div class="col-md-6">
													<div class="form-group required">
														...
														<div class="input-group"><span class="input-group-addon">
															<i class="glyphicon glyphicon-user"></i></span>
															<input name="business_name" id="con_business" class="form-control" placeholder="Business Name" autocomplete="off" value="" type="text">
