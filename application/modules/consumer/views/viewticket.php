...
function loadTableData(){
    var url = site_url+"consumer/ticket/viewnote/"+'<?php echo $this->uri->segment('4'); ?>';
    $('#example').dataTable( {
    	"searching":false,
        "serverSide": true,
        "ajax" : url,
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
		<div class="addNote">
			...
			<h3>Add Note</h3>
		<?php echo form_open('consumer/ticket/addnote',array('class'=>'addForm','id'=>'add_ticnote','enctype'=>'multipart/form-data','autocomplete'=>'off')); ?>
