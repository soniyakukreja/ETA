                                        ...
                                        <div class="newestTicket filterTable chengHead">
                                            <div class="row">
                                                <div class="col-md-6">
                                                    ...
                                                    <table id="my_newest_ticket" class="table table-striped table-bordered dataTable">
                                                        <thead>
                                                            <tr>
                                                                <th>Ticket Number</th>
                                                                <th>Category</th>
...
<script type="text/javascript" src="<?php echo base_url('includes/js/cto_dashboard.js'); ?>"></script>
