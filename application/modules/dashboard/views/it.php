                                    ...
                                    <div class="filterDiv">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-6">
                                                            ...
                                                            <div id="ticketperstaff_404" style="display:none;">No New Tickets Generated</div>
                                        ...
                                        <div class="filterTable chengHead">
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="pandu">
                                                        <h3>Upcoming MBRs<span class="shohin msgNote" id="mbr_note">Showing upcoming 2 weeks</span></h3>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="pandu">
                                                        <h3>Upcoming QBRs<span class="shohin msgNote" id="qbr_note">Showing upcoming 2 weeks</span></h3>
                                        ...
                                        <div class="filterTable chengHead">
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="pandu">
                                                        <h3>Upcoming ABRs<span class="shohin msgNote" id="abr_note">Showing upcoming 2 weeks</span></h3>
...
<script type="text/javascript" src="<?php //echo base_url('includes/js/dash_ticket.js'); ?>"></script>
<script type="text/javascript" src="<?php echo base_url('includes/js/dashboard_functions.js'); ?>"></script>
<script type="text/javascript" src="<?php echo base_url('includes/js/cto_eta.js'); ?>"></script>
<script type="text/javascript" src="<?php //echo base_url('includes/js/eta_cto.js'); ?>"></script>
</div>
</body>
</html>