                            ...
                            <div class="innerDiv">
                                ...
                                <div class="filterBody">
                                    <div class="filterDiv">
                                        ...
                                        <div class="filterTable exportButton expBtn <?php if(!in_array('IA_A',$perms) && !in_array('IA_EXP',$perms)){ echo 'expoTable'; }elseif(in_array('IA_EXP',$perms) && !in_array('IA_A',$perms)){ echo 'proTable'; } ?>">
                                            <?php if(in_array('IA_A',$perms)){ ?>   
                                                <a href="<?php echo site_url() ?>industryassociation/addia" class="addNew n-m-70 <?php if(in_array('IA_A',$perms) && !in_array('IA_EXP',$perms)){ echo 'addBtnTablr'; } ?>">Add New</a>
                                            <?php }?> 
                                            <?php if(in_array('IA_EXP',$perms)){?> 
                                            <!-- <a href="<?php echo site_url() ?>industryassociation/export" style='margin-right: -73px;' class="addNew n-m-70">Export</a>  -->
