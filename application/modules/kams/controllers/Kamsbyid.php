...
class Kamsbyid extends MX_Controller {
   ...
   public function __construct(){
    ...
    public function kams($id)
    {
        $data['id'] = $id;
        $this->load->view('viewkamsbyid',$data);
    }


    public function ajaxkams($id)
    {
        ...
        $datatables->edit('profilepicture', function ($data) {
            ...
            if($data['profilepicture']){
        		...
        		$datatables->edit('ids', function ($data) {
        			return '<input type="checkbox" name="id" value="'.$data['user_id'].'">';
        		});
 	...
 	public function viewkamsia()
    {
        $this->load->view('viewkamsla');
    }

    public function ajaxkamsia()
    {
