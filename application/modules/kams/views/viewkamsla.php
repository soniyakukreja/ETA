...
<article>
								...
								<div class="filterBody">
									<div class="filterDiv">
										...
										<div class="filterTable exportButton">
											...
											<form action="<?php echo site_url() ?>kams/exportia" method="POST">
											...
											<table id="example" class="table table-striped table-bordered" style="width:100%">
										        <thead>
										            <tr class="n-blue-bg">
										                <th><input type="checkbox" name="id"  id="selectall"></th>
										                <th>ID</th>
	...
	<script type="text/javascript" charset="utf-8">
        function loadData() {
            var url = "<?php echo site_url() ?>kams/Kams/ajaxkamsia/<?php echo $iaid; ?>";
            // alert(url); 
            $('#example').dataTable( {
                "serverSide": true,
                "ajax" : url,
