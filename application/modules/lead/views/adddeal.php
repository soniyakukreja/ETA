									...
									<div class="filterDiv">
										...
										<?php echo form_open('',array('class'=>'addForm','id'=>'add_deal','autocomplete'=>'off')); ?>
											<div class="row">
												...
												<div class="col-md-6">
													<div class="form-group required">
														...
														<div class="input-group"><span class="input-group-addon">
															<i class="glyphicon glyphicon-user"></i></span>
															<input name="bus_name" id="deal_business" class="form-control" placeholder="Business Name" autocomplete="off" value="" type="text">
											...
											<div class="row">	
												<div class="col-md-6">
													<div class="form-group required">
														...
														<div class="dateInput"><span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
															<select class="form-control js-example-basic-single" name="cp" id="cp">
																<option value="">First Select Business</option>
															</select>
														</div>
											...
											<div class="row">
												...
												<?php /*<a href="javascript:window.history.go(-1);" class="addNew">Back</a>*/ ?>
												<a onclick="window.history.back()" class="addNew">Back</a>
											</div>
										<?php echo form_close(); ?>
									</div>
