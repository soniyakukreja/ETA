...
.expBtn button.addNew, .expBtn a.addNew {
    left: unset;
    top: unset;
}
								...
								<div class="filterBody">
									<div class="filterDiv expBtn ">
										...
										<div class="filterTable exportButton expBtn">
											<a href="<?php echo site_url() ?>lead/business/addnew" class="addNew n-m-70">Add New</a>
											<!-- <button class="addNew">Export</button> -->
											<!-- <a href="<?php echo site_url() ?>lead/business/export" style='margin-right: -73px;' class="addNew n-m-70">Export</a> --> 
											<form action="<?php echo site_url() ?>lead/business/export" method="POST">
