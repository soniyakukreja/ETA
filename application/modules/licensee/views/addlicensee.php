						...
						<div class="dashBody">
							<div class="innerDiv">
								...
								<div class="filterBody">
									<div class="filterDiv">
										<p class="toAdd">To add a new License, you must enter the following details.</p>
										...
										<?php echo form_open('',array('class'=>'addForm','id'=>'add_licensee','enctype'=>'multipart/form-data','autocomplete'=>'off')); ?>
											<div class="row">
												<div class="col-md-6">
													<div class="form-group required">
														...
														<div class="input-group"><span class="input-group-addon"> 
															...
															<input  name="lic_number" id="lic_number" placeholder="License Number" class="form-control" value="" type="text" autocomplete="off">
														</div>
														...
														<div class="row">
															<div class="col-md-6">
																<div class="form-group required">
																	...
																	<div class="dateInput"><span class="input-group-addon">
																		...
																		<input name="lic_startdate" id="lic_startdate" class="form-control datepicker_from" type="text" onkeydown="event.preventDefault()"  autocomplete="off" Placeholder="Start Date" >
																	</div>
															...
															<div class="col-md-6">
																<div class="form-group required">
																	...
																	<div class="dateInput"><span class="input-group-addon">
																		<i class="glyphicon glyphicon-calendar"></i></span>
																		<input name="lic_enddate" id="lic_enddate" class="form-control datepicker datepicker_to" type="text" onkeydown="event.preventDefault()"  autocomplete="off" Placeholder="End Date">
																	</div>
												...
												<div class="col-md-6">
													<div class="form-group">
														...
														<div class="input-group"><span class="input-group-addon">
															...
															<input name="license_file" id="license_file" class="form-control pdffile" value="" type="file" accept=".pdf"  autocomplete="off" is_valid="1">
												...
												<div class="col-md-6">
													<div class="form-group">
														...
														<div class="input-group"><span class="input-group-addon">
															...
															<input type="hidden" name="lic_profilepicture_h" id="lic_profilepicture_h" class="hiddenfile">
															<i class="fa fa-times-circle removeFile" aria-hidden="true"></i>
														</div>
											...
											<div class="row">
												<div class="col-md-6">
													<div class="form-group required">
														...
														<div class="input-group"><span class="input-group-addon">
															...
															<input  name="firstname" id="firstname" class="form-control" placeholder="CTO First Name" value="" type="text"  autocomplete="off">
														</div>
												...
												<div class="col-md-6">
													<div class="form-group required">
														...
														<div class="input-group"><span class="input-group-addon">
															<i class="glyphicon glyphicon-user"></i></span>
															<input  name="lastname" id="lastname" class="form-control" placeholder="CTO Last Name" value="" type="text"  autocomplete="off">
														</div>
												...
												<div class="col-md-6">
													<div class="form-group required">
														...
														<div class="input-group"><span class="input-group-addon">
															...
															<input name="email" id="email" class="form-control"  value="" type="email" placeholder="CTO Email Address"  autocomplete="off">
														</div>
											...
											<div class="row">
												<div class="col-md-6">
													<div class="form-group">
														...
														<label>Only Supported Files are JPG, JPEG, PNG</label>
														<br>
														<span id="cto_profile_err" class="invalidText image_err"></span>
													</div>
												</div>
												<div class="col-md-6">
													<div class="form-group required">
														<label>Country</label>
														<div class="dateInput"><span class="input-group-addon"><i class="glyphicon glyphicon-flag"></i></span>
															<select class="form-control js-example-basic-single" name="l_country" id="l_country"  autocomplete="off">
															  <option value="">Please Select</option>
												...
												<div class="col-md-6">
													<div class="form-group required">
														...
														<div class="input-group"><span class="input-group-addon"
																...
																- Symbols">
															<i class="glyphicon glyphicon-user"></i></span>
															<input  name="cpassword" id="cpassword" class="form-control" placeholder="Confirm Password" value="" type="password" onpaste="return false;" autocomplete="off" >
												...
												<div class="col-md-6">
													<div class="form-group required">
														...
														<div class="input-group"><span class="input-group-addon">
															...
															<?php }else{ ?>
															<input name="business_name" id="licensee_business" class="form-control" placeholder="Business Name" autocomplete="off" value="" type="text">
												...
												<div class="row">
													<div class="col-md-6">
														<div class="form-group required">
															...
															<div class="input-group"><span class="input-group-addon">
																<i class="glyphicon glyphicon-road"></i></span>
																<input name="address" id="address" class="form-control" placeholder="Street Address" autocomplete="off" value="" type="text">
															</div>
													...
													<div class="col-md-6">
														<div class="form-group required">
															...
															<div class="input-group"><span class="input-group-addon">
																<i class="glyphicon glyphicon-road"></i></span>
																<input name="suburb" id="suburb" class="form-control" placeholder="Suburb/Province" autocomplete="off" value="" type="text">
															</div>
...
<?php $this->load->view('licensee/licensee_js.php'); ?>
</div>
</body>
</html>