								...
								<div class="filterBody">
									<div class="filterDiv">
										...
										<div class="filterTable exportButton expBtn <?php if(!in_array("BN_A",$perms)){ echo 'proTable'; } ?>">
											...
											<?php }?>
											<!-- <a href="<?php echo site_url() ?>marketing/exportbannerlic" style='margin-right: -73px;' class="addNew n-m-70">Export</a> --> 
											<form action="<?php echo site_url() ?>marketing/exportbannerlic" method="POST">
...
function loadTableData(){
            var url = "<?php echo site_url() ?>marketing/ajaxbannerbylic/<?php echo $id; ?>";
            $('#example').dataTable( {
                "serverSide": true,
                "ajax" : url,
