								...
								<div class="filterBody">
									<div class="filterDiv">
										...
										<div class="filterTable exportButton">
											...
											<?php echo form_open('product/updateproductia',array('class'=>'addForm','id'=>'updateproduct','enctype'=>'multipart/form-data','autocomplete'=>'off')); ?>
												<input type="hidden" name="ia_id" value="<?php echo $ia_id; ?>">
...
function loadTableData(){
            var url = "<?php echo site_url() ?>product/Product/assignprodia/<?php echo $ia_id; ?>";
            // alert(url); 
            $('#example').dataTable( {
                "serverSide": true,
                "ajax" : url,
