								...
								<div class="filterBody">
									<div class="filterDiv">
										...
										<div class="filterTable exportButton">
											...
											<form action="<?php echo site_url() ?>product/exportia" method="POST">
												<input type="hidden" name="search" id="searchfltr">
											<button class="addNew">Export</button>
											</form>
											<!-- <a href="<?php echo site_url() ?>product/exportia" style='margin-right: -73px;' class="addNew n-m-70">Export</a>  -->
...
function loadTableData(){
            var url = "<?php echo site_url() ?>product/Product/ajaxia";
            // alert(url); 
            $('#example').dataTable( {
                "serverSide": true,
                "ajax" : url,
