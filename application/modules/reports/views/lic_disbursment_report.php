...
<div id="successMsg" class="alert alert-success hide"></div>                                        
                                        ...
                                        <?php echo form_open('reports/export_lic_disburse'); ?>
                                        <div class="row">
                                        ...
                                        <div class="row formDate">
                                            ...
                                            <div class="col-md-6 col-sm-12 col-xs-12 reportExpo expBtn">
...
<script>
var lic = "<?php echo $this->session->userdata['licenseeid']; ?>";
function loadTableData(){
    var url = site_url+"reports/lic_disbursment_report_ajax";
    $('#example').dataTable( {
        "serverSide": true,
        "ajax" : url,
        "order": [[1, "asc" ]],
...
loadTableData();
getTotals('<?php echo date("m/Y",strtotime('last month')); ?>','<?php echo date("m/Y",strtotime('last month')); ?>',lic);

function getTotals(st_date,end_date,lic){
    $.ajax({
        url: site_url+"reports/lic_monthly_disbrs_total",
        type: "POST",
...
function filterData(){
    ...
    var url = site_url+"reports/filter_lic_disburs";
    $('#example').dataTable({
        "serverSide": true,
        "responsive": true,
        "order": [[1, "asc" ]],
