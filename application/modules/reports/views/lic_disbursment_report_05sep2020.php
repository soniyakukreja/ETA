...
function loadTableData(){
    var url = "<?php echo site_url('reports/lic_disbursment_report_ajax'); ?>";
    $('#example').dataTable( {
        "serverSide": true,
        "ajax" : url,
        "order": [[0, "asc" ]],
...
function getTotals(st_date,end_date){
    $.ajax({
        url: "<?php echo site_url('reports/getTotal_monthly_disbrs/'); ?>",
        type: "POST",
...
function filterData(){
    ...
    var url = "<?php echo site_url('reports/filter_lic_disburs/'); ?>";
    $('#example').dataTable({
        "serverSide": true,
        "responsive": true,
        "order": [[0, "asc" ]],
