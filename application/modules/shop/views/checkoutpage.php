								...
								<div class="cartDetail">
									<div class="filterBody">
										<div class="filterDiv">
													...
													<div class="bilDetail">
														...
														<div>
															...
															<div class="form-group required">
																...
																<input type="text" name="au_business" id="au_business" class="form-control" placeholder="Enter your Business Name">
															...
															<div class="form-group">
																...
																<input type="text" name="alt_address" id="alt_address" class="form-control" placeholder="Enter your address">
													...
													<div class="bilDetail">
														...
														<div class="myBill form-group">
															<label>
																...
																<span></span> Is Billing and Shipping Address the same?
															</label>
														</div>
														<div id="shipDiv" style="display:none;">
															...
															<div class="form-group">
																<label>Alternate Address </label>
																<input type="text" name="alt_shaddress" id="alt_shaddress" class="form-control" placeholder="Enter your address">
																<span id="alt_shaddress_err" class="invalidText"></span>
															</div>																	
															<div class="form-group required">
																<label>City </label>
																<input type="text" name="sh_city" id="sh_city" class="form-control" placeholder="Enter your City">
															...
															<div class="form-group required">
																...
																<input type="text" name="sh_state" id="sh_state" class="form-control" placeholder="Enter your State or Region">
														...
														<?php }else{ ?>
														<div class="payBtn form-group">
															<a class="addNew" href="javascript:void(0);" id="gotopayment">Continue</a>															
														</div>
														<?php } ?>
														<div class="payBtn">
												...
												<div class="col-md-4">
													<div class="bilDetail">
														...
														?>
															...
															<div class="payBtn form-group">
																<a class="addNew" href="javascript:void(0)" id="gotopayment">Go to Payment</a>
															</div>
											...
											<div id="paymentDiv" style="display:none;" class="divsec">
												<div class="col-md-4">
													<div class="bilDetail">
	  ...
	  <strong>Success!</strong>
														...
														<h3>Payment</h3>
															...
															<div class="form-group">
																...
																<span id="pay_mode_err" class="invalidText"></span>
															</div>
															*/ ?>
															
															<div class="form-group required">
																<label>Card Number </label>
																<input type="text" name="card_number"id="card_number" class="form-control" placeholder="Enter your card number" maxlength="16">
																<span id="card_err" class="invalidText">Please Add Valid Card Number</span>
															</div>
															<div class="form-group required">
																...
																<div class="row">
																	<div class="col-md-4">
																		...
																		<span id="month_err" class="invalidText"></span>
																	</div>
																	<div class="col-md-4">
																		...
																		<span id="year_err" class="invalidText"></span>
																	</div>
																	<div class="col-md-4">
																		<input type="text" name="cvc" id="cvc" class="form-control" placeholder="CVC">
																		<span id="cvc_err" class="invalidText"></span>
																	</div>
																</div>
															</div>
															<div class="payBtn form-group">
																<button class="addNew" id="confirmPayment" type="submit">Confirm Order</button>
															</div>

														<?php if(!empty($add_ques)){ ?>
														<div class="payBtn">
															<a class="veiwPro" href="javascript:void(0);" id="gotoadd_ques">Back to Additional Questions</a>
														</div>
														<?php }else{ ?>
														<div class="payBtn form-group">
															<a class="veiwPro" href="javascript:void(0);" id="gotoAddress">Back to Billing/Shipping Details</a>															
											...
											<div class="col-md-4">
												<div class="bilDetail">
																...
																foreach($products as $product){ 
																	...
																	<tr>
																		...
																		<td>
																			...
																			<b><?php echo $product['prod_qty']; ?> x <?php echo numfmt_format_currency($this->fmt,$product['c_price'], "USD"); ?></b>
																			<br>
													...
													<div class="totalCart">
														<p>Cart Total <?php echo numfmt_format_currency($this->fmt,$carttotal, "USD"); ?></p>
													</div>
												</div>
											</div>
...
$('#orderForm').on('submit',function(e){
	...
	// var pay_mode = $('#pay_mode :selected').val();

	// if (pay_mode == '') {
	// 	$("#pay_mode").focus();
	// 	$("#pay_mode_err").show().html('Please Select Payment Mode');
 //        allIsOk = false;
 //    }

	if($('#card_number').val() =='' || $('#card_number').val().length !=16){
		//$("#card_number").focus();
        $("#card_err").css('display','block');
        allIsOk = false;
	}	
