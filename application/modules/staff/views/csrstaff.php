								...
								<div class="filterBody">
									<div class="filterDiv">
										...
										<div class="filterTable exportButton expBtn">
											...
											<form action="<?php echo site_url() ?>staff/exportcsr" method="POST">
												<input type="hidden" name="search" id="searchfltr">
												<button class="addNew">Export</button>
											</form>
											<table id="example" class="table table-striped table-bordered tr" style="width:100%">
										        <thead>
										            <tr class="n-blue-bg">
										               <th>ID</th>
 ...
 <?php $this->load->view('include/confim_popup.php'); ?>
	...
	<script type="text/javascript" charset="utf-8">
        function loadTableData() {
            var url = "<?php echo site_url();?>staff/Staff/ajaxcsrstaff";
            // alert(url); 
            $('#example').dataTable( {
                "serverSide": true,
                "ajax" : url,
