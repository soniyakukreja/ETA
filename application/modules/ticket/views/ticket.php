								...
								<div class="filterBody">
									<div class="filterDiv">
										...
										<div class="filterTable exportButton expBtn <?php  echo $class; ?>">
											...
											<a href="<?php echo site_url() ?>ticket/addticket" class="addNew" <?php if(in_array("TIC_EXP",$perms)){ ?> style="margin-right: 70px;"<?php } ?> >Add New</a>
											<?php }?>
											<?php 
											 if(in_array("TIC_EXP",$perms)) {?>
                                            <form action="<?php echo site_url() ?>ticket/export" method="POST">
...
function loadTableData(){
            var url = "<?php echo site_url() ?>ticket/Ticket/ajax";
            // alert(url); 
            $('#example').dataTable( {
                "serverSide": true,
                "ajax" : url,
