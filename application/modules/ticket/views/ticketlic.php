                                    ...
                                    <div class="filterDiv">
                                       ...
                                       <?php $class = '';
                                        ...
                                        <div class="filterTable exportButton expBtn <?php  echo $class; ?>">
                                            ...
                                            <?php }?>
                                            <!-- <a href="<?php echo site_url() ?>ticket/ticket_account/exportlic" style='margin-right: -73px;' class="addNew n-m-70">Export</a>  -->
                                           <?php if(in_array("TIC_EXP",$perms)) {?>
                                            <form action="<?php echo site_url() ?>ticket/ticket_account/exportlic" method="POST">
...
function loadTableData(){
            var url = "<?php echo site_url() ?>ticket/ticket_account/ajaxlic/<?php echo $id; ?>";
            // alert(url); 
            $('#example').dataTable( {
                "serverSide": true,
                "ajax" : url,
