			...
			<ul>
				<li>';
					...
					if(in_array('LIC_KAM_V',$perms))
						echo '<li><a href="'.site_url().'kams/kamsbyid/kams/'.$id.'">KAMs and CSRs</a></li>';
					if(in_array('LIC_IA_V',$perms))
						echo '<li><a href="'.site_url().'industryassociationbyid/viewia/'.$id.'">Industry Associations</a></li>';
					if(in_array('LIC_BR_V',$perms))
						echo '<li><a href="'.site_url().'business_reviewbyid/licbusiness_review/'.$id.'">Business Reviews</a></li>';
					if(in_array('LIC_TIC_V',$perms))
						echo '<li><a href="'.site_url().'ticket/ticket_accountbyid/ticketlic/'.$id.'">Tickets</a></li>';
					/*if(in_array('LIC_PRODC_V',$perms))
						echo '<li><a href='.site_url("licensee/productbylic").'>Products</a></li>';*/
					if(in_array('LIC_BN_V',$perms))
						echo '<li><a href="'.site_url().'licensee/bannerbylic/'.$id.'">Marketing</a></li>';
					echo '</ul>'; ?>
				</li>
			</ul>
		</li>
