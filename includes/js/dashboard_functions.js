...
tpc_labels = tpc_values = tpc_bg=  tcp_ul_li='';
...
tps_labels = tps_values = tps_bg= tps_ul_li = '';
...
function ia_disburse(){
  var st_date = $('#startdate').val();
  var end_date = $('#enddate').val();

  var url = site_url+'dashboard/ia_disburse';
    $('#ia_disburse').dataTable({
        "serverSide": true,
        "responsive": true,
        "order": [[0, "asc" ]],
        "lengthMenu": [10,20, 50, 100],
...
function lic_disburse(){
  var st_date = $('#startdate').val();
  var end_date = $('#enddate').val();

  var url = site_url+'dashboard/lic_disburse';
    $('#lic_disburse').dataTable({
        "serverSide": true,
        "responsive": true,
        "order": [[0, "asc" ]],
        "lengthMenu": [10,20, 50, 100],
...
function reconciliation(){
  ...
  var url = site_url+'dashboard/reconciliation';
