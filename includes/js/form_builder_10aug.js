$(document).ready(function () {
    ...
    function getPreview(plain_html = '') {
        ...
        el.each(function () {
            ...
            nameArr = ['fname','lname','email','address','city','state','postcode','country','ship_add_checkbox',
                        'sh_address','sh_city','sh_state','sh_postcode','sh_country','add_info','card_number','month','year','cvc','stripeToken'];

            if(nameArr.includes(name.trim())){
                alert('Field with this name already exist in checkout form, please use another name for your additional field');
                return false;
            }
            ...
            if (data_type === 'text') {
                ...
                html += '<div class="form-group"><label class="control-label">' + label + '</label><input type="text" name="' + name + '" placeholder="' + placeholder + '" class="form-control add_field" ' + required + '/></div>';
            }
            if (data_type === 'number') {
                var placeholder = $(this).find('.form_input_placeholder').val();
                var checkbox = $(this).find('.form-check-input');
                ...
                html += '<div class="form-group"><label class="control-label">' + label + '</label><input type="number" name="' + name + '" placeholder="' + placeholder + '" class="form-control add_field" ' + required + '/></div>';
            }
            if (data_type === 'email') {
                var placeholder = $(this).find('.form_input_placeholder').val();
                var checkbox = $(this).find('.form-check-input');
                ...
                html += '<div class="form-group"><label class="control-label">' + label + '</label><input type="email" name="' + name + '" placeholder="' + placeholder + '" class="form-control add_field" ' + required + '/></div>';
            }
            if (data_type === 'password') {
                ...
                html += '<div class="form-group"><label class="control-label">' + label + '</label><input type="password" name="' + name + '" placeholder="' + placeholder + '" class="form-control add_field" ' + required + '/></div>';
            }
            if (data_type === 'textarea') {
                ...
                html += '<div class="form-group"><label class="control-label">' + label + '</label><textarea rows="5" name="' + name + '" placeholder="' + placeholder + '" class="form-control add_textarea" ' + required + '></textarea></div>';
            }
            if (data_type === 'date') {
                var checkbox = $(this).find('.form-check-input');
                var required = '';
                ...
                html += '<div class="form-group"><label class="control-label">' + label + '</label><input type="date" name="' + name + '" class="form-control add_field" ' + required + '/></div>';
            }
            if (data_type === 'button') {
            ...
            if (data_type === 'select') {
                ...
                html += '<div class="form-group"><label class="control-label">' + label + '</label><select class="form-control add_dropdown" name="' + name + '"  ' + required + '>' + option_html + '</select></div>';
            }
            if (data_type === 'radio') {
                var required = '';
                var checkbox = $(this).parents('.form_builder_field').find('.form-check-input');
                ...
                $(this).find('.mt-radio').each(function () {
                    ...
                    option_html += '<div class="form-check"><label class="form-check-label"><input type="radio" class="form-check-input add_radio" name="' + name + '" value="' + value + '" ' + required + '>' + option + '</label></div>';
                });
            ...
            if (data_type === 'checkbox') {
                ...
                $(this).find('.mt-checkbox').each(function () {
                    ...
                    option_html += '<div class="form-check"><label class="form-check-label"><input type="checkbox" class="form-check-input add_checkbox" name="' + name + '[]" value="' + value + '" ' + required + '>' + option + '</label></div>';
                });
                html += '<div class="form-group"><label class="control-label">' + label + '</label>' + option_html + '</div>';
            }
        });
        ...
        if (plain_html === 'html') {
            ...
            if(html==''){ 
                ...
                var editable_html = $('.bal_builder').html();
            }
